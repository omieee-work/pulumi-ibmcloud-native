...
namespace Pulumi.ibmcloud
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.ibmcloud.version.txt");
    ...
    internal sealed class ibmcloudResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public ibmcloudResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
